...
export const BalanceCard = (props: Props) => {
    ...
    return (
        <PureClientOnly>
            <div
                className={`flex items-center justify-between bg-white border rounded-xl p-4 w-full ${isSigna ? "" : "hover:bg-gray-200"}`}
                onClick={isSigna ? () => {
                } : navigateToTokenTransfer}>
